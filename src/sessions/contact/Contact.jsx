        ...
        <div className="cont-right">
          ...
          <form ref={formRef} >
            <div className="cont-input">
              ...
              <input onChange={handleTextInput} name='fullname' required className='inp' type="text" placeholder='full name'  />
            </div>
            <div className="cont-input">
              <span className="sub-text">Enter email</span>
              <input onChange={handleTextInput} required name='email' className='inp' type="email" placeholder='email address'  />
            </div>
            <div className="cont-input">
              <span className="sub-text">Enter subject</span>
              <input onChange={handleTextInput} name='subject' required className='inp' type="text" placeholder='subject'  />
            </div>
            <div className="cont-input">
              <span className="sub-text">Enter message</span>
              <textarea onChange={handleTextInput} name='body' rows={5} required className='inp' placeholder='subject'  />
            </div>
            {
              message.alert &&
            ...
            <button onClick={sendMessage} className='cont-button' >{isLoading ? 'Processing...':'Send'}</button>
          </form>
          ...
          <div className="cont-down">
            <a href='tel:770 854 1894' className="phone-container">
              ...
              <button onClick={openBooking} className='book-button' >Book a call</button>
          </div>
        </div>
      </div>
    </div>
